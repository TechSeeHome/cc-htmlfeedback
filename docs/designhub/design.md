...
- Agent path: a Claude Code session reads open tickets from a Sheet and posts a reply,
  ...
  (`home-knowledge@techsee.me`) to prove the standing access grant (Shared Drive membership, D18)
