  ...
  function reconcile(tickets){
    ...
    tickets.forEach(t => {
      ...
      if(!f){
        ...
        // adopted and marked as sent — found in review, this guard is not optional.
        f = Object.values(store).find(x => !x.draft && !x.sid && x.quote === (t.quote || '') && x.note === (t.note || '') && x.page === (t.page || ''));
